...
//		}
	...
	public int getFuture() {
		return this.balance + getRemainCount() * this.pay;
	}
	...
	public void show() {
		...
		System.out.println("납입회차: " + this.getCount() + "/" + this.getTotalCount() + "회차");
		System.out.println("계좌잔액: " + this.getBalance() + "원");
		
		if(this.isFinish()) {
			System.out.println("* 해당 적금은 만기되었습니다* ");
		} else {
			System.out.println("* 만기 예상금액: " + this.getFuture());
		}
	}
