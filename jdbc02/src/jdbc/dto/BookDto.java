...
public class BookDto {
	...
	public void setBookPublicationDate(String bookPublication) {
		this.bookPublicationDate = bookPublication;
	}
	...
	public String toString() {
		return "BookDto [bookId=" + bookId + ", bookTitle=" + bookTitle + ", bookAuthor=" + bookAuthor
				+ ", bookPublication=" + bookPublicationDate + ", bookPrice=" + bookPrice + ", bookPublisher="
