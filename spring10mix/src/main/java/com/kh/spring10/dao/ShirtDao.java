...
public class ShirtDao {
	...
	public void insert(ShirtDto dto) {
		String sql = "insert into shirt("
				+ "shirt_no, shirt_name, shirt_color, shirt_price, shirt_kind, shirt_type, "
				+ "shirt_material, shirt_stock) values("
				+ "?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public boolean update(ShirtDto dto) {
		String sql = "update shirt set "
				+ "shirt_name=?, shirt_color=?, shirt_price=?, shirt_kind=?, shirt_type=?,"
