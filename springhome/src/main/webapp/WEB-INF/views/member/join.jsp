	...
	<div class="container w-400">
            ...
            <div class="row left">
               ...
               <label for="id-input">아이디<span class="important">*</span></label> 
                <input type="text" name="memberId" class= "form-input w-100" placeholder="영문 소문자+숫자 5~20자 이내"
                id="id-input">
            </div>
            ...
            <div class="row left">
                <label style="display: block;" class="mb-10">주소</label>
                <input type="text" name="memberPost" class= "form-input w-100" placeholder="우편번호" style="width:8em;">
